...
class ConfigSwitchGenerator(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        ...
        val configManager = ClassName("uk.kagurach.kaguram.config", "ConfigManager")
        val defines = ClassName("uk.kagurach.kaguram.utils", "Defines")
        val dependencies = mutableListOf<KSFile>()

        resolver.getSymbolsWithAnnotation("uk.kagurach.kaguram.BooleanConfig")
        ...
        resolver.getSymbolsWithAnnotation("uk.kagurach.kaguram.IntConfig")
            .filterIsInstance<KSPropertyDeclaration>()
            .toList()
            .let {
                if (it.isEmpty()) return@let
        ...
        resolver.getSymbolsWithAnnotation("uk.kagurach.kaguram.StringConfig")
            .filterIsInstance<KSPropertyDeclaration>()
            .toList()
            .let {
                if (it.isEmpty()) return@let
        ...
        if (!finished) FileSpec.builder("uk.kagurach.gen", "Config")
