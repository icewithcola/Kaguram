...
package uk.kagurach.kaguram.activity;

import static uk.kagurach.kaguram.UIKt.createMessageFilterSetter;
...
import uk.kagurach.kaguram.helpers.EntitiesHelper;
import uk.kagurach.kaguram.ui.PopupBuilder;
import uk.kagurach.kaguram.ui.StickerSizePreviewMessagesCell;
import uk.kagurach.kaguram.ui.sortList.ItemTouchHelperCallback;
import uk.kagurach.kaguram.ui.sortList.SortListAdapter;
import uk.kagurach.kaguram.ui.sortList.TextStyleListAdapter;
...
public class ChatSettingActivity extends BaseActivity {
    ...
    private int confirmToRepeatRow;
    ...
    protected void onItemClick(View view, int position, float x, float y) {
        ...
        } else if (position == confirmToRepeatRow) {
            Config.toggleConfirmToRepeat();
            if (view instanceof TextCheckCell) {
                ((TextCheckCell) view).setChecked(Config.confirmToRepeat);
            }
    ...
    protected void updateRows() {
        ...
        confirmToRepeatRow = addRow("confirmToRepeat");
            ...
            switch (holder.getItemViewType()) {
                ...
                case TYPE_SETTINGS: {
                    ...
                    if (position == stickerSizeRow) {
                        ...
                        textCell.setTextAndValue(LocaleController.getString("MarkdownParser", R.string.MarkdownParser), Config.newMarkdownParser ? "Kaguram" : "Telegram", payload,
                ...
                case TYPE_CHECK: {
                    ...
                    if (position == ignoreBlockedUserMessagesRow) {
                        ...
                        textCell.setTextAndCheck(LocaleController.getString("confirmToRepeat", R.string.confirmToRepeat), Config.confirmToSendMediaMessages, true);
                    } else if (position == unreadBadgeOnBackButtonRow) {
