...
import uk.kagurach.kaguram.activity.BaseActivity;
import uk.kagurach.kaguram.activity.ChatSettingActivity;
import uk.kagurach.kaguram.activity.ExperimentSettingActivity;
import uk.kagurach.kaguram.activity.GeneralSettingActivity;
import uk.kagurach.kaguram.activity.MainSettingActivity;
import uk.kagurach.kaguram.activity.PasscodeSettingActivity;
...
public class SettingsHelper {
    ...
    public static void processDeepLink(Uri uri, Callback callback, Runnable unknown) {
        ...
        if (segments.isEmpty() || segments.size() > 2 || !"kaguramsettings".equals(segments.get(0))) {
            unknown.run();
            return;
        }
