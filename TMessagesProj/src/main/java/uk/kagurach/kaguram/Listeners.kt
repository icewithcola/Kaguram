...
class KaguramPushService : NotificationListenerService() {
...
class SaveToDownloadReceiver : BroadcastReceiver() {
    companion object {
        ...
        private const val ACTION_CANCEL = "uk.kagurach.kaguram.SAVE_TO_DOWNLOAD_CANCEL"
        private const val EXTRA_ID = "uk.kagurach.kaguram.NOTIFICATION_ID"
