...
-keepclassmembernames class uk.kagurach.kaguram.activity.DatacenterActivity$DatacenterCell { <fields>; }
-keepclassmembernames class uk.kagurach.kaguram.activity.DatacenterActivity$DatacenterHeaderCell { <fields>; }
-keepclassmembernames class uk.kagurach.kaguram.activity.MessageDetailActivity$TextDetailSimpleCell { <fields>; }
-keepclassmembernames class uk.kagurach.kaguram.activity.PasscodeSettingActivity$AccountCell { <fields>; }
-keepclassmembernames class uk.kagurach.kaguram.activity.ChatSettingActivity$StickerSizeCell { <fields>; }
...
-assumenosideeffects class uk.kagurach.kaguram.utils.Log {
    public static *** d(...);
}
